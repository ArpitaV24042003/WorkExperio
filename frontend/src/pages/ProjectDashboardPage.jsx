...
            <div className="grid grid-cols-4 p-4 bg-gray-100 font-bold text-sm text-gray-600 border-b">
                <div>File Name</div>
                <div>Size</div>
                <div>Date Added</div>
                <div>Actions</div>
            </div>
            {files.map((file) => (
                <div key={file.id} className="grid grid-cols-4 p-4 border-b last:border-b-0 hover:bg-gray-50 transition">
